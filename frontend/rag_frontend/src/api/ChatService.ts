...
export const getPreviousConversations = async (userId: string): Promise<DBQueryModel[]> => {
  try {
...
export const submitQuery = async (username: string, queryText: string): Promise<string> => {
